<p align="center">
  <img src="assets/readme_pic.jpeg" alt="Science Kit Bot Icon" width="80%">
</p>
...
## Command List
 There are also `ALIASES`, You can type for example `/convert 25 km foot` 
 or use unit's full name `/convert 25 kilometer foot`


| Command                                   | Example               | Result                                            |
|:------------------------------------------|:----------------------|:--------------------------------------------------|
| `/about`                                  |                       | Receive a short description                                       |
| `/convert help`                           |                       | Receive a list of supported units                   |
| `/convert help (category name)`           | `/convert help mass`  | Receive a list of supported units for mass category |
| `/convert (number) (from unit) (to unit)` | `/convert 25 km foot` | 25,00 kilometer = 82020,9974 foot              |
